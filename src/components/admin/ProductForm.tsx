  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          title: "Error",
          description: data.message || "Gagal menambahkan produk",
          variant: "destructive",
        });
      }
    } catch (error) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleInputChange("currentPrice", parseInt(e.target.value))
                }
                className="w-full p-2 border rounded-md"
                required
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleInputChange("fullPrice", parseInt(e.target.value))
                }
                className="w-full p-2 border rounded-md"
                required
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => handleInputChange("prodigyId", e.target.value)}
                className="w-full p-2 border rounded-md"
              />
            </div>
          </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-2 mb-4">
            <input
              ...
              value={newSku.size}
              onChange={(e) =>
                setNewSku((prev) => ({ ...prev, size: e.target.value }))
              }
              placeholder="Size"
            ...
            <input
              ...
              value={newSku.sku}
              onChange={(e) =>
                setNewSku((prev) => ({ ...prev, sku: e.target.value }))
              }
              placeholder="SKU"
              className="p-2 border rounded-md"
            />
            <input
              ...
              value={newSku.gtin}
              onChange={(e) =>
                setNewSku((prev) => ({ ...prev, gtin: e.target.value }))
              }
              placeholder="GTIN"
              className="p-2 border rounded-md"
            />
