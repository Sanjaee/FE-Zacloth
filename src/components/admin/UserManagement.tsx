              ...
              <div className="px-4 lg:px-6">
                <div className="mb-8">
                  ...
                  <p className="text-gray-600">
                    Create and manage user accounts with QR code generation
                  </p>
                </div>
                  ...
                  <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-8">
                      ...
                      <div className="flex items-center justify-between bg-white p-3 rounded border">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <Button
                            ...
                            variant="outline"
                            onClick={() =>
                              copyToClipboard(generatedUser.username)
                            }
                          >
                            Copy
                          </Button>
                      ...
                      <div className="flex items-center justify-between bg-white p-3 rounded border">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <Button
                            ...
                            variant="outline"
                            onClick={() =>
                              copyToClipboard(generatedUser.password)
                            }
                          >
                            Copy
                          </Button>
                      ...
                      <div className="flex items-center justify-between bg-white p-3 rounded border">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <Button
                            ...
                            variant="outline"
                            onClick={() =>
                              copyToClipboard(generatedUser.profile.id)
                            }
                          >
                            Copy
                          </Button>
                    ...
                    <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded">
                      <p className="text-yellow-800 text-sm">
                        ⚠️ <strong>Important:</strong> Please save these
                        credentials securely. The password cannot be retrieved
                        again.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                      <div className="flex-1">
                        <p className="text-blue-700 mb-4">
                          QR code automatically generated for this user's
                          profile. When scanned, it will direct to their profile
                          page.
                        </p>
                      </div>
                          ...
                          <div className="mt-4 text-center">
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              <Button
                                ...
                                variant="outline"
                                onClick={() =>
                                  copyToClipboard(qrCodeData.profileUrl)
                                }
                              >
                                Copy
                              </Button>
